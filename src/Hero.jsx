import { FaceFrownIcon, GifIcon, IdentificationIcon, KeyIcon, LifebuoyIcon, MapIcon, QuestionMarkCircleIcon, StarIcon } from '@heroicons/react/16/solid'
  ...
  return (
    <div className='w-full h-fit sm:h-130  flex flex-col sm:flex-row items-center gap-3 sm:gap-6  p-3 '>
        <div className='bg-secondary/ flex-1 h-full flex flex-col mb-2'>
          ...
          <p className='mt-4 mb-1 px-3 sm:px-0 text-text-third   text-lg text-center sm:text-left line-clamp-3 sm:line-clamp-6'>I design and build fast, modern, and scalable <b>web applications</b>.My main expertise is <b>frontend and backend development</b>, supported by strong skills in <b>graphic design</b> and <b>motion design.</b></p>
          ...
          <div className='w-full h-10 rounded-3xl bg-secondary mt-3 flex items-center p-2 justify-between'> 
            <FaceFrownIcon className='size-6 text-text'/> 
            <IdentificationIcon className='size-6 text-text'/> 
            <FaceFrownIcon className='size-6 text-text'/> 
            <BoltIcon className='size-6 text-text'/> 
            <MapIcon className='size-6 text-text'/> 
            <KeyIcon className='size-6 text-text'/> 
            <LifebuoyIcon className='size-6 text-text'/> 
          </div>
