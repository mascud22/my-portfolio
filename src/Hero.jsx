  ...
  return (
    <div className='w-full h-fit sm:h-130  flex flex-col sm:flex-row items-center gap-3 sm:gap-6  p-3 '>
        <div className='bg-secondary/ flex-1 h-full flex flex-col mb-2'>
          ...
          <h1  style={{ fontFamily: 'Poppins, sans-serif' }} className='text-text text-[36px] sm:text-5xl ml-1 mt-1 font-semibold  text-center sm:text-left '>Web Developer & <span className=' text-text-third'>Creative Designer Visionary •  </span> </h1>
